...
function dashboardEcharts() {
  ...
  var option = {
    ...
    color: [
      "rgba(70, 128, 255, 0.95)",
      "rgba(70, 128, 255, 0.39)",
      "rgba(70, 128, 255, 0.54)",
    ],
    yAxis: [
      {
        type: "value",
    ...
    options: [
      {
        ...
        legend: {
          ...
          orient: "vertical",
          padding: 0,
          data: ["Fund-1", "Fund-2", "Fund-3", "Fund-4", "Fund-5"],
        },
        toolbox: {
          show: false,
        ...
        series: [
          {
            ...
            data: [
              { value: 35, name: "Fund-1" },
              { value: 16, name: "Fund-2" },
              { value: 27, name: "Fund-3" },
              { value: 29, name: "Fund-4" },
              { value: 12, name: "Fund-5" },
            ],
          },
        ],
      },
        ...
        series: [
          {
            ...
            type: "pie",
            data: [
              { value: 42, name: "Fund-1" },
              { value: 51, name: "Fund-2" },
              { value: 39, name: "Fund-3" },
              { value: 25, name: "Fund-4" },
              { value: 9, name: "Fund-5" },
            ],
          },
        ],
        ...
        series: [
          {
            ...
            type: "pie",
            data: [
              { value: 29, name: "Fund-1" },
              { value: 16, name: "Fund-2" },
              { value: 24, name: "Fund-3" },
              { value: 19, name: "Fund-4" },
              { value: 5, name: "Fund-5" },
            ],
          },
        ],
